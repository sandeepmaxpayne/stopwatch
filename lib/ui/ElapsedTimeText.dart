...
class ElapsedTimeText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        TimeDigit(minuteStr.substring(0, 1), width: digitWidth),
        TimeDigit(minuteStr.substring(1, 2), width: digitWidth),
        TimeDigit(':', width: 6),
        TimeDigit(secondStr.substring(0, 1), width: digitWidth),
        TimeDigit(secondStr.substring(1, 2), width: digitWidth),
        TimeDigit('.', width: 6),
